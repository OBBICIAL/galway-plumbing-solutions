...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 md:bottom-6 md:right-6 bg-green-500 text-white p-3 md:p-4 rounded-full shadow-2xl shadow-green-500/40 hover:bg-green-600 hover:scale-110 transition-all duration-300 z-50 flex items-center justify-center group"
