  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white border-b border-slate-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center group py-2 shrink-0 mr-2">
          <Image 
            src="/logo.jpg" 
        ...
        <div className="flex items-center gap-1.5 md:gap-4 shrink-0">
          <button 
            ...
            className="text-brand-900 font-semibold border-2 border-brand-900 px-2 py-1.5 md:px-4 md:py-2 rounded-lg hover:bg-slate-50 transition-colors text-[11px] sm:text-xs md:text-base whitespace-nowrap"
          >
          ...
          <a 
            ...
            className="bg-accent-orange hover:bg-orange-600 text-white font-bold px-2 py-1.5 md:px-5 md:py-2.5 rounded-lg flex items-center gap-1 md:gap-2 shadow-sm transition-transform active:scale-95 text-[11px] sm:text-xs md:text-base whitespace-nowrap"
          >
            <Phone className="w-3 h-3 md:w-5 md:h-5 animate-pulse" />
